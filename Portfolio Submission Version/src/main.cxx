...
private:
    ...
    static const uint32_t TOTAL_COMPOSITION_SAMPLERS = COLOR_ATTACHMENT_COUNT*3;
    ...
    const uint32_t WORLD_X = 90;
    const uint32_t WORLD_Y = 90;
    ...
    void createOffScreenRenderPass(OffScreenRenderPass &offScreenRenderPass) {
		...
		for (uint32_t i = 0; i < COLOR_ATTACHMENT_COUNT+1; i++) {
			...
			attachmentDescs[i].loadOp = i >= COLOR_ATTACHMENT_COUNT-1 ? VK_ATTACHMENT_LOAD_OP_CLEAR : VK_ATTACHMENT_LOAD_OP_DONT_CARE;
    ...
    void createOnScreenDescriptorSets() {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            compositionImageInfo[4].imageView = reflectRenderPass.positionAttachment.view;
            ...
            compositionImageInfo[5].imageView = reflectRenderPass.colorAttachment.view;
            ...
            compositionImageInfo[6].imageView = reflectRenderPass.normalAttachment.view;
            ...
            compositionImageInfo[7].imageView = reflectRenderPass.bloomAttachment.view;
            ...
            compositionImageInfo[8].imageView = refractRenderPass.positionAttachment.view;
            compositionImageInfo[8].sampler = compositionSampler;
            compositionImageInfo[9].imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
            compositionImageInfo[9].imageView = refractRenderPass.colorAttachment.view;
            compositionImageInfo[9].sampler = compositionSampler;
            compositionImageInfo[10].imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
            compositionImageInfo[10].imageView = refractRenderPass.normalAttachment.view;
            compositionImageInfo[10].sampler = compositionSampler;
            compositionImageInfo[11].imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
            compositionImageInfo[11].imageView = refractRenderPass.bloomAttachment.view;
            compositionImageInfo[11].sampler = compositionSampler;
    ...
    void recreateOnScreenDescriptorSets() {
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
            ...
            compositionImageInfo[6].sampler = compositionSampler;
            compositionImageInfo[6].imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
            compositionImageInfo[6].imageView = reflectRenderPass.bloomAttachment.view;
            compositionImageInfo[6].sampler = compositionSampler;
            ...
            compositionImageInfo[10].imageView = refractRenderPass.normalAttachment.view;
            compositionImageInfo[10].sampler = compositionSampler;
            compositionImageInfo[11].imageLayout = VK_IMAGE_LAYOUT_GENERAL;
            compositionImageInfo[11].imageView = refractRenderPass.bloomAttachment.view;
            compositionImageInfo[11].sampler = compositionSampler;
    ...
    void blitToBloom(VkCommandBuffer commandBuffer) {
        VkFormatProperties formatProperties;
        vkGetPhysicalDeviceFormatProperties(physicalDevice, mainRenderPass.bloomAttachment.format, &formatProperties);
        ...
        VkImageMemoryBarrier barrier{};
        barrier.sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER;
        barrier.image = mainRenderPass.bloomAttachment.image;
        barrier.srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
        barrier.dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
        barrier.subresourceRange.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
        barrier.subresourceRange.baseArrayLayer = 0;
        ...
        vkCmdBlitImage(commandBuffer,
            mainRenderPass.bloomAttachment.image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
